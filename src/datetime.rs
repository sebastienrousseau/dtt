...
lazy_static::lazy_static! {
    static ref TIMEZONE_OFFSETS: HashMap<&'static str, Result<UtcOffset, DateTimeError>> = {
        ...
        let _ = m.insert("ACDT", UtcOffset::from_hms(10, 30, 0).map_err(DateTimeError::from));
        let _ = m.insert("ACST", UtcOffset::from_hms(9, 30, 0).map_err(DateTimeError::from));
        let _ = m.insert("ADT", UtcOffset::from_hms(-3, 0, 0).map_err(DateTimeError::from));
        ...
        let _ = m.insert("AKDT", UtcOffset::from_hms(-8, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("AKST", UtcOffset::from_hms(-9, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("AST", UtcOffset::from_hms(-4, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("AWST", UtcOffset::from_hms(8, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("BST", UtcOffset::from_hms(1, 0, 0).map_err(DateTimeError::from));
        ...
        let _ = m.insert("ECT", UtcOffset::from_hms(-4, 0, 0).map_err(DateTimeError::from));
        ...
        let _ = m.insert("HADT", UtcOffset::from_hms(-9, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("HAST", UtcOffset::from_hms(-10, 0, 0).map_err(DateTimeError::from));
        ...
        let _ = m.insert("IDT", UtcOffset::from_hms(3, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("JST", UtcOffset::from_hms(9, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("KST", UtcOffset::from_hms(9, 0, 0).map_err(DateTimeError::from));
        ...
        let _ = m.insert("NZDT", UtcOffset::from_hms(13, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("NZST", UtcOffset::from_hms(12, 0, 0).map_err(DateTimeError::from));
        ...
        let _ = m.insert("WADT", UtcOffset::from_hms(8, 45, 0).map_err(DateTimeError::from));
        let _ = m.insert("WAST", UtcOffset::from_hms(7, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("WEDT", UtcOffset::from_hms(1, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("WEST", UtcOffset::from_hms(1, 0, 0).map_err(DateTimeError::from));
        let _ = m.insert("WET", Ok(UtcOffset::UTC));
        m
    };
}
